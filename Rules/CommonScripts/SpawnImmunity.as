...
f32 onPlayerTakeDamage(CRules@ this, CPlayer@ victim, CPlayer@ attacker, f32 DamageScale)
{
	...
	if (victimblob !is null && victimblob.getTickSinceCreated() < (victimblob.exists("custom immunity time") ? victimblob.get_u32("custom immunity time") : (getTicksASecond() * IMMUNITY_SECS)) && victim !is attacker)
	{
