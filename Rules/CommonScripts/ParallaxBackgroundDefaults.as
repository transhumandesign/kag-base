...
void SetDefaultBackgrounds(CRules@ rules)
{
    ...
    RepeatedParallaxBackground@ plains = AddScriptedBackground("Sprites/Back/BackgroundPlains.png", Vec2f(0.0f, -250.0f), 80.0f, 100.0f, color_white, baseZ);
    RepeatedParallaxBackground@ trees = AddScriptedBackground("Sprites/Back/BackgroundTrees.png", Vec2f(0.0f,  -220.0f), 160.0f, 150.0f, color_white, baseZ + 10.0f);
    RepeatedParallaxBackground@ island = AddScriptedBackground("Sprites/Back/BackgroundIsland.png", Vec2f(0.0f, -120.0f), 190.0f, 170.0f, color_white, baseZ + 20.0f);
    RepeatedParallaxBackground@ island2 = AddScriptedBackground("Sprites/Back/BackgroundIsland.png", Vec2f(-400.0f, -120.0f), 200.0f, 180.0f, color_white, baseZ + 30.0f);
    RepeatedParallaxBackground@ castle = AddScriptedBackground("Sprites/Back/BackgroundCastle.png", Vec2f(0.0f, -110.0f), 220.0f, 190.0f, color_white, baseZ + 40.0f);
