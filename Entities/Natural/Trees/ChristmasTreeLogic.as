...
void GrowSprite(CSprite@ this, TreeVars@ vars)
{
	...
	for (uint i = 0; i < segments.length; i++)
	{
		...
		if (segment !is null && !segment.gotsprites)
		{
			...
			{
				CSpriteLayer@ newsegment = this.addSpriteLayer("segment " + i, "Trees_Christmas.png" , 16, 16, 0, 0);
			...
			{
				CSpriteLayer@ newsegment = this.addSpriteLayer("leaves " + i, "Trees_Christmas.png" , 32, 32, 0, 0);
			...
			else if (segment.grown_times == 5)
			{
				...
				{
					f32 flipsign = 1.0f;
					CSpriteLayer@ newsegment = this.addSpriteLayer("roots", "Trees_Christmas.png" , 32, 16, 0, 0);
				...
				{
					bool flip = false;
					CSpriteLayer@ newsegment = this.addSpriteLayer("leaves side " + i, "Trees_Christmas.png" , 32, 32, 0, 0);
					...
					if (XORRandom(2) == 0)
					{
						CSpriteLayer@ secondnewsegment = this.addSpriteLayer("leaves doubleside " + i, "Trees_Christmas.png" , 32, 32, 0, 0);
